...
export class TouchControls {
  ...
  // 创建时一旦确认是触控设备，就不要因熄屏恢复期间短暂错误的能力探测而隐藏。
  private touchDeviceDetected: boolean;
  ...
  constructor(parent: HTMLElement, mobile: MobileControls) {
    ...
    this.mobile = mobile;
    this.parent = parent;
    this.touchDeviceDetected = isTouchDevice() || isMobile();
  ...
  autoShow(): void {
    ...
    this.setVisible(this.touchDeviceDetected);
  }
