  ...
  constructor(parent: HTMLElement, settings: GameSettings, cb: MainMenuCallbacks) {
    ...
    this.root.innerHTML = `
      <div class="mm-inner">
        ...
        <p class="mm-subtitle">本地双人回合制坦克炮战</p>
        <div class="mm-players">
          ...
          <div class="mm-card p2">
            <div class="mm-tag">P2</div>
            <div class="mm-name" id="mm-p2">${escapeHtml(settings.player2Name)}</div>
          </div>
        </div>
        <div class="mm-actions">
          <button id="mm-play" class="btn btn-primary btn-large">开始本地双人游戏</button>
        ...
        <p class="mm-hint">两人共用同一套按键 / 触控按钮轮流操作</p>
      </div>
    `;
